...
#ifndef KohnShamDFTGeneralisedEigenOperatorClass_H_
#define KohnShamDFTGeneralisedEigenOperatorClass_H_
#include <constants.h>
...
namespace dftfe
{
  // KohnShamDFTGeneralisedEigenOperator is derived from KohnShamDFTBaseOperator
  ...
  class KohnShamDFTGeneralisedEigenOperator
